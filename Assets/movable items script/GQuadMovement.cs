...
public class GQuadMovement : MonoBehaviour
{
    public float speed = 5f; // Speed of the quad's movement
    private Vector3 startPosition = new Vector3(-2, 0, 5.0999999f);
    private Vector3 endPosition = new Vector3(2, 0, 5.0999999f);
