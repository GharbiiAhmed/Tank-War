...
namespace TanksMP
{
    ...
    public class GameManager : MonoBehaviourPun
    {
        ...
        public void SendGameResult(bool isVictory)
        {
            ...
            string userId = SessionManager.Instance.GetUserID(); // You might need to implement this based on how your user IDs are managed
        ...
        {
            string url = "http://localhost:9090/users/" + userId + "/game-result"; // Ensure the URL is correct
            string jsonData = "{\"result\":\"" + result + "\"}";

            Debug.Log("Sending game result to: " + url);
