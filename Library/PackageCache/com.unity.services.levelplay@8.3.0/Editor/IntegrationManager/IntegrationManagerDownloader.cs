...
namespace Unity.Services.LevelPlay.Editor.IntegrationManager
{
    class IntegrationManagerDownloader
    {
        ...
        const string k_IronsourceSDKInfo = "https://s3.amazonaws.com/ssa.public/Network-Manager/staging/8.3.0/IronSourceSDKInfo.json";
        const string k_IronsourceSDKXMLLinks = "https://s3.amazonaws.com/ssa.public/Network-Manager/staging/8.3.0/IronSourceSDKLinks.json";
        const string k_IronsourceUnityPackageVersions = "https://s3.amazonaws.com/ssa.public/Network-Manager/staging/8.3.0/PackageVersionNativeCompatibility.json";
